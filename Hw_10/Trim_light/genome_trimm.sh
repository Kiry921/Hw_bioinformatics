...
-baseout ~/classes/class_10/trimmed/illumina_reads_trim4.fastq \
-trimlog ~/classes/class_10/trimmed/illumina_reads_trim4.fastq \
ILLUMINACLIP:/projects/mipt_dbmp_biotechnology/genome/adapters.fa:2:30:10 SLIDINGWINDOW:4:20 MAXINFO:50:0.2 LEADING:20 TRAILING:20 MINLEN:36